...
\begin{samepage}
    ...
    \begin{onecolentry}
        ...
        ((* if entry.journal -*))
        \textit{<<entry.journal>>}((* if entry.doi *)), doi: \href{<<entry.doi_url>>}{<<entry.doi|escape_latex_characters>>}((* elif entry.url *)) \href{<<entry.url>>}{<<entry.clean_url|escape_latex_characters>>}((* endif *))
        ((* else -*))
        ((* if entry.doi -*))
